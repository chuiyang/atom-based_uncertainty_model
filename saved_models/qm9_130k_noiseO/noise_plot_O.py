...
def barChart(smiles, uncertainty, x_label, std, unc_tag, model_i=0):
    ...
    y_2O = np.zeros(5) 
    y_3Oup = np.zeros(5) 
    O_dict = {0: y_0O, 1: y_1O, 2: y_2O, 3: y_3Oup}
    ...
    plt.savefig(f'./O_noise_plot_std{std}_{unc_tag}_15e_post.png', dpi=650)
...
if __name__ == '__main__':
    ...
    # for std in [0, 1, 3]:
        # model 0 (1 model only)
        # uncertaintyCountNumN(f'./qm9_130k_pear_scale_2l_15e_lr_std{std}/each_pred/qm9_130k_noiseO_test_pear_scale_2l_15e_lr_std{std}_0.csv', std, 'ale')
    ...
    filename = f'./qm9_130k_pear_scale_2l_15e_lr_std{std}_post/fold_0/qm9_130k_noiseO_test_pear_scale_2l_15e_lr_std{std}_post.csv'
        # filename = f'./qm9_130k_pear_scale_2l_15e_lr_std{std}/each_pred/qm9_130k_noiseO_test_pear_scale_2l_15e_lr_std{std}_{model_i}.csv'
