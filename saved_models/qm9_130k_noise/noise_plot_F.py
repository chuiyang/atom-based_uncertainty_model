...
def barChart(smiles, uncertainty, x_label, std, unc_tag, model):
    ...
    plt.savefig(f'./F_noise_plot_std{std}_{unc_tag}_15e_post_2468.png', dpi=650)
...
if __name__ == '__main__':
    ...
    # filename = f'./qm9_130k_pear_scale_2l_30e_lr_std{std}/each_pred/qm9_130k_noise_test_pear_scale_2l_30e_lr_std{std}_0.csv'
