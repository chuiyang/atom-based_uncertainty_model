...
for model in range(15):
    file_before = pd.read_csv(f'./qm9_130k_pear_scale_2l_30e_lr_std0/each_pred/qm9_130k_noise_test_pear_scale_2l_30e_lr_std0_{model}.csv')
...
file_after = pd.read_csv('./qm9_130k_pear_scale_2l_30e_lr_std0_post/fold_0/qm9_130k_noise_test_pear_scale_2l_30e_lr_std0_post.csv')
