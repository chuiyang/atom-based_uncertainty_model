...
def barChart(smiles, uncertainty, x_label, std, unc_tag, model=None):
    ...
    plt.savefig(f'./Br_noise_plot_std{std}_{unc_tag}_30e_post.png', dpi=650)
...
def uncertaintyCountNumN(filepath, std, unc_tag, model=None):
    ...
    ale_unc = file['logSOL_ale_unc'].values
    epi_unc = file['logSOL_epi_unc'].values
...
if __name__ == '__main__':
    ...
    std = 0
    filename = f'./delaney_1128_pear_scale_2l_30e_post/fold_0/delaney_1128_test_pear_scale_2l_30e_post.csv'
