...
def barChart(smiles, uncertainty, x_label, std, unc_tag, model=None):
    ...
    plt.savefig(f'./noise_plot_std{std}_{unc_tag}_30e_post.png', dpi=650)
...
if __name__ == '__main__':
    ...
    std = 0
    filename = f'./qm9_130k_pear_scale_2l_30e_lr_post/fold_0/qm9_130k_smiles0_test_pear_scale_2l_30e_lr_post.csv'
