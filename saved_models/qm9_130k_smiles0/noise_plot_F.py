...
def barChart(smiles, uncertainty, x_label, std, unc_tag):
    ...
    plt.savefig(f'./F_noise_plot_std{std}_{unc_tag}_30e_post.png', dpi=650)





def uncertaintyCountNumN(filepath, std, unc_tag):
    ...
    barChart(smiles, unc, title, std, unc_tag)
