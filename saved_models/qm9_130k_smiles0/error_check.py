...
for model in range(30):
    file_before = pd.read_csv(f'./qm9_130k_pear_scale_2l_30e_lr/each_pred/qm9_130k_smiles0_test_pear_scale_2l_30e_lr_{model}.csv')
...
file_after = pd.read_csv('./qm9_130k_pear_scale_2l_30e_lr/fold_0/qm9_130k_smiles0_test_pear_scale_2l_30e_lr.csv')

smiles = file_after['smiles'].values
preds_ens = file_after['pred_Hf'].values
