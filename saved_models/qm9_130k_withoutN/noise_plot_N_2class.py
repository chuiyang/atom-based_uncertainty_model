...
def barChart(smiles, uncertainty, x_label, std, unc_tag, model=None):
    ...
    plt.savefig(f'./noise_plot_{unc_tag}_15e_2class.png', dpi=650)
...
if __name__ == '__main__':
    std = 0
    filename = f'./qm9_130k_pear_scale_2l_15e_withoutN_seed20_post/fold_0/qm9_130k_withoutN_test_pear_scale_2l_15e_withoutN_seed20_post.csv'
