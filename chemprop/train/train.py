...
def train(model: nn.Module,
    ...
    for i in range(0, num_iters, iter_size):
        # print(f'iter: {i}') # , args.batch_size: {args.batch_size}, {len(data)}
        # Prepare batch
        ...
        # print(f'iter_count: {iter_count}, loss: {loss}, batch: {batch[:3]}')
        ...
        if (n_iter // args.batch_size) % args.log_frequency == 0:
            ...
            # info(f'Loss = {loss_avg:.4e}, PNorm = {pnorm:.4f}, GNorm = {gnorm:.4f}, {lrs_str}')
