...
def active_learning(args: Namespace, logger: Logger = None, active_iter: int = 0, logger_all: Logger = None) -> Tuple[float, float]:
    ...
    # test logger_all
    model_scores, model_rmse, model_mae = run_training_atl(args, logger, active_iter, logger_all)
