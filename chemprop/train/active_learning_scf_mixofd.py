...
from .run_training_atl_scf_mixofd import run_training_atl_scf_mixofd
from chemprop.data.utils import get_task_names
from chemprop.utils import makedirs


def active_learning_scf_mixofd(args: Namespace, logger: Logger = None, active_iter: int = 0, logger_all: Logger = None) -> Tuple[float, float]:
    ...
    # test logger_all
    model_scores, model_rmse, model_mae = run_training_atl_scf_mixofd(args, logger, active_iter, logger_all)
